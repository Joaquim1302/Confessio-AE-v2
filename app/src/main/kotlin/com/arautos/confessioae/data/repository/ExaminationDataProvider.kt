...
object ExaminationDataProvider {
    val items = listOf(
        ...
        ExaminationItem("d6", "Se passei muito tempo sem buscar o Sacramento da Confissão (Roteiro). Quanto tempo?", Category.DEUS),
        ...
        ExaminationItem("d11", "Se escondi algum pecado grave no Roteiro por vergonha ou outro motivo, ou o fiz sem dor dos pecados.", Category.DEUS),
        ExaminationItem("d12", "Se pequei pensando na facilidade de obter o perdão através do Roteiro.", Category.DEUS),
        ...
        ExaminationItem("p9", "Se cometi defeitos ou faltas de meu próximo sem necessidade.", Category.PROXIMO),
