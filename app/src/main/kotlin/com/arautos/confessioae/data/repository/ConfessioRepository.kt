...
class ConfessioRepository(private val context: Context) {
    ...
    private object PreferencesKeys {
        ...
        val EXPLANATIONS = stringPreferencesKey("explanations")
    }
    ...
    val explanationsJson: Flow<String?> = context.dataStore.data
        .map { preferences ->
            preferences[PreferencesKeys.EXPLANATIONS]
        }
    ...
    suspend fun updateExplanationsJson(json: String) {
        context.dataStore.edit { preferences ->
            preferences[PreferencesKeys.EXPLANATIONS] = json
        }
    }
